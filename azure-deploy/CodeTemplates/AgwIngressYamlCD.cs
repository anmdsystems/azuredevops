...
namespace ngCodeGen.CodeTemplates
{
    ...
    #line 1 "C:\research\azure-deploy\CodeTemplates\AgwIngressYamlCD.tt"
    [global::System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.VisualStudio.TextTemplating", "16.0.0.0")]
    public partial class AgwIngressYamlCD : AgwIngressYamlCDBase
    {
#line hidden
        /// <summary>
        ...
        public virtual string TransformText()
        {
            ...
            #line 14 "C:\research\azure-deploy\CodeTemplates\AgwIngressYamlCD.tt"
...
// TEMPLATE CODE HERE
            ...
            #line 30 "C:\research\azure-deploy\CodeTemplates\AgwIngressYamlCD.tt"
            ...
            #line 31 "C:\research\azure-deploy\CodeTemplates\AgwIngressYamlCD.tt"
            ...
            #line 38 "C:\research\azure-deploy\CodeTemplates\AgwIngressYamlCD.tt"
...
for (Int32 i = 0; i < stages.Length; ++i) {
    ...
    if (environment.ToLower() == "int") {
        customCondition = "eq(variables['Build.SourceBranch'], 'refs/heads/develop')";
            ...
            #line 57 "C:\research\azure-deploy\CodeTemplates\AgwIngressYamlCD.tt"
      ...
      - task: AzureResourceGroupDeployment@2
        ...
        inputs:
          azureSubscription: '");
            ...
            #line 65 "C:\research\azure-deploy\CodeTemplates\AgwIngressYamlCD.tt"
            ...
            #line 66 "C:\research\azure-deploy\CodeTemplates\AgwIngressYamlCD.tt"
            ...
            #line 67 "C:\research\azure-deploy\CodeTemplates\AgwIngressYamlCD.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(deploymentLocationName));
            
            #line default
            #line hidden
            this.Write("\'\r\n          csmFile: ArmTemplate/azuredeploy.agw.");
            
            #line 68 "C:\research\azure-deploy\CodeTemplates\AgwIngressYamlCD.tt"
            ...
            #line 71 "C:\research\azure-deploy\CodeTemplates\AgwIngressYamlCD.tt"
 if (useTm) {
      ...
      - task: AzureResourceGroupDeployment@2
        ...
        inputs:
          azureSubscription: '");
            ...
            #line 78 "C:\research\azure-deploy\CodeTemplates\AgwIngressYamlCD.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(azureServiceConnectionName));
            ...
            #line 79 "C:\research\azure-deploy\CodeTemplates\AgwIngressYamlCD.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(resourceGroup));
            ...
            #line 80 "C:\research\azure-deploy\CodeTemplates\AgwIngressYamlCD.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(deploymentLocationName));
            
            #line default
            #line hidden
            this.Write("\'\r\n          csmFile: \'ArmTemplate/azuredeploy.trafficmanager.");
            
            #line 81 "C:\research\azure-deploy\CodeTemplates\AgwIngressYamlCD.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(stage.Name));
            ...
            #line 83 "C:\research\azure-deploy\CodeTemplates\AgwIngressYamlCD.tt"
}
            
            #line default
            #line hidden
            
            #line 84 "C:\research\azure-deploy\CodeTemplates\AgwIngressYamlCD.tt"
        ...
        customCondition = $"eq(variables['Build.SourceBranch'], {buildSourceBranch})";
            ...
            #line 97 "C:\research\azure-deploy\CodeTemplates\AgwIngressYamlCD.tt"
            ...
            #line 98 "C:\research\azure-deploy\CodeTemplates\AgwIngressYamlCD.tt"
            ...
            #line 100 "C:\research\azure-deploy\CodeTemplates\AgwIngressYamlCD.tt"
            ...
            #line 101 "C:\research\azure-deploy\CodeTemplates\AgwIngressYamlCD.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(environment.ToLower()));
            ...
            #line 102 "C:\research\azure-deploy\CodeTemplates\AgwIngressYamlCD.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(environment.ToLower()));
            ...
            #line 104 "C:\research\azure-deploy\CodeTemplates\AgwIngressYamlCD.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(environment));
            ...
            #line 105 "C:\research\azure-deploy\CodeTemplates\AgwIngressYamlCD.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(customCondition));
            ...
            #line 110 "C:\research\azure-deploy\CodeTemplates\AgwIngressYamlCD.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(azureServiceConnectionName));
            ...
            #line 111 "C:\research\azure-deploy\CodeTemplates\AgwIngressYamlCD.tt"
            ...
            #line 112 "C:\research\azure-deploy\CodeTemplates\AgwIngressYamlCD.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(resourceGroup));
            ...
            #line 113 "C:\research\azure-deploy\CodeTemplates\AgwIngressYamlCD.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(deploymentLocationName));
            ...
            #line 115 "C:\research\azure-deploy\CodeTemplates\AgwIngressYamlCD.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(stage.Name));
            ...
            #line 118 "C:\research\azure-deploy\CodeTemplates\AgwIngressYamlCD.tt"
 if (useTm) {
            
            #line default
            #line hidden
            this.Write("    - job: deployTrafficManager");
            
            #line 119 "C:\research\azure-deploy\CodeTemplates\AgwIngressYamlCD.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(environment));
            ...
            #line 120 "C:\research\azure-deploy\CodeTemplates\AgwIngressYamlCD.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(customCondition));
            ...
            #line 125 "C:\research\azure-deploy\CodeTemplates\AgwIngressYamlCD.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(azureServiceConnectionName));
            ...
            #line 126 "C:\research\azure-deploy\CodeTemplates\AgwIngressYamlCD.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(subscriptionId));
            ...
            #line 127 "C:\research\azure-deploy\CodeTemplates\AgwIngressYamlCD.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(resourceGroup));
            ...
            #line 128 "C:\research\azure-deploy\CodeTemplates\AgwIngressYamlCD.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(deploymentLocationName));
            
            #line default
            #line hidden
            this.Write("\'\r\n          templateLocation: \'Linked artifact\'\r\n          csmFile: \'ArmTemplate" +
                    "/azuredeploy.trafficmanager.");
            
            #line 130 "C:\research\azure-deploy\CodeTemplates\AgwIngressYamlCD.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(stage.Name));
            ...
            #line 132 "C:\research\azure-deploy\CodeTemplates\AgwIngressYamlCD.tt"
}
...
SaveOutputToSubFolder(codeGenPath, $"{data.Id}\\{data.TeamName.ToLower()}-ingress-infra\\CD", "azure-pipelines.yml");    
        ...
        #line 139 "C:\research\azure-deploy\CodeTemplates\AgwIngressYamlCD.tt"
...
public AgwIngressYamlCD(string deployment, string rootTemplatePath) {
    ...
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.VisualStudio.TextTemplating", "16.0.0.0")]
    public class AgwIngressYamlCDBase
    {
        #region Fields
